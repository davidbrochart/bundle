...
--        bit 5~0 - mem_i_V[5:0] (Read/Write)
--        others  - reserved
-- 0x14 : reserved
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_MEM_I_V_DATA_0) then
                    int_mem_i_V(5 downto 0) <= (UNSIGNED(WDATA(5 downto 0)) and wmask(5 downto 0)) or ((not wmask(5 downto 0)) and int_mem_i_V(5 downto 0));
                end if;
            end if;
        end if;
    end process;
